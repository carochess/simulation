...
plot(cif2,ylim=c(0,0.40),xlab="Time (days)",ylab="Cumulative incidence", 
     ...
     main=c(paste("True CIF Plot - Simulated Data Controls"), paste("n=100,000 Patients (Scenario 3)")))
legend(x="topleft",c("Control PCa CIF: 14.4%", "Control OD CIF: 20.6%"),
...
plot(cif1,ylim=c(0,0.40),xlab="Time (days)",ylab="Cumulative incidence", 
     ...
     main=c(paste("True CIF Plot - Simulated Data"), paste("n=100,000 Patients (Scenario 3)")))
lines(cif2,col=c("blue","blue"),lwd=2,lty=c(1,2),conf.int=F)

legend(x="topleft",c("Treated PCa CIF: 12.1%","Control PCa CIF: 14.4%",
                     "Treated OD CIF: 21.2%", "Control OD CIF: 20.6%"),
