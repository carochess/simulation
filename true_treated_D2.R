...
A<-ifelse(v<=g, 1, 0)
table(A) ##all patients were treated
...
plot(cif1,ylim=c(0,0.40),xlab="Time (days)",ylab="Cumulative incidence", 
     ...
     main=c(paste("True CIF Plot - Simulated Data Treated"), paste("n=100,000 Patients (Scenario 2)")))
legend(x="topleft",c("Treated PCa CIF: 9.7%", "Treated OD CIF: 27.3%"),
