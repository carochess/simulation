...
plot(cif2,ylim=c(0,0.40),xlab="Time (days)",ylab="Cumulative incidence", 
     ...
     main=c(paste("True CIF Plot - Simulated Data Controls"), paste("n=100,000 Patients (Scenario 2)")))
legend(x="topleft",c("Control PCa CIF: 11.7%", "Control OD CIF: 26.3%"),
...
plot(cif1,ylim=c(0,0.40),xlab="Time (days)",ylab="Cumulative incidence", 
     ...
     main=c(paste("True CIF Plot - Simulated Data"), paste("n=100,000 Patients (Scenario 2)")))
lines(cif2,col=c("blue","blue"),lwd=2,lty=c(1,2),conf.int=F)

legend(x="topleft",c("Treated PCa CIF: 9.7%","Control PCa CIF: 11.7%",
                     "Treated OD CIF: 27.3%", "Control OD CIF: 26.3%"),
